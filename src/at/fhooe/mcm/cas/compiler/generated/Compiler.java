...
public class Compiler implements CompilerConstants {
	...
	public static void main(String[] _argv) {
		try {
			...
			Compiler.evaluate("dt_now EQUALS Day");
			System.out.println();
			Compiler.evaluate("dt_now EQUALS Night");
			System.out.println();
			//Compiler.evaluate("dt_now EQUALS 10");
			System.out.println();
			Compiler.evaluate("10 EQUALS Day");
			System.out.println();
		} catch (Exception _e) {
			_e.printStackTrace();
		}
	...
	final public void daytime_comparison() throws ParseException {
		jj_consume_token(EQUALS);
		daytime_stmt();
	}

	final public void daytime_stmt() throws ParseException {
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case DT:
			jj_consume_token(DT);
			break;
		case CONTEXT_IDENTIFIER_DT:
			jj_consume_token(CONTEXT_IDENTIFIER_DT);
			break;
		default:
			jj_la1[1] = jj_gen;
			jj_consume_token(-1);
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x1041, 0x1040, };
	}
