 ...
 *
 */
public class CtxController extends WindowAdapter
		implements ActionListener, ComponentListener, MouseListener, MouseWheelListener, MouseMotionListener, KeyListener, ItemListener, ChangeListener {

	private CtxModel mModel;

	/**
	 * View
	 */
	private CtxView mView;
	 ...
	 */
	public CtxController(CtxModel _m) {
		mModel = _m;
	 ...
	 * @param _v
	 */
	public void addView(CtxView _v) {
		mView = _v;
	}
...
//		}
	...
	public void stateChanged(ChangeEvent e) {
		...
		switch(js.getName()) {
			case "TimeOfTheDay":
				mModel.setDate((Date)js.getModel().getValue());
				break;
			case "TransFrequ":
			...
			case "Humidity":
				...
				break;
			case "Pressure":
				mModel.setPressure((int)js.getValue());
				break;
			default:
				//do nothing
		}
